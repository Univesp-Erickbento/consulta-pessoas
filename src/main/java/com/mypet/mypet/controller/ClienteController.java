...
public class ClienteController {
    ...
    public ResponseEntity<?> adicionarCliente(@RequestBody ClienteDTO clienteDTO) {
        try {
            ...
            // Passo 2: Chamar a rota Camel para buscar a pessoa por CPF
            ...
            if (pessoaJson != null && !pessoaJson.isEmpty()) {
                // Passo 3: Converter o JSON da resposta para um Map
                ObjectMapper objectMapper = new ObjectMapper();
                Map<String, Object> pessoaMap = objectMapper.readValue(pessoaJson, HashMap.class);

                // Passo 4: Verificar se a pessoa já possui o perfil de cliente
                if (pessoaMap.get("perfis").toString().contains("CLIENTE")) {
                    ...
                    // Passo 5: Adicionar o perfil de cliente à pessoa existente
                    ...
                    // Passo 6: Criar e preparar o objeto cliente para salvar, sem enviar o CPF
