...
public class FuncionarioController {
    ...
    public ResponseEntity<?> adicionarFuncionario(@RequestBody FuncionarioDTO funcionarioDTO) {
        try {
            // Obter o CPF do FuncionarioDTO
            ...
            if (pessoaJson != null && !pessoaJson.isEmpty()) {
                ...
                // Verificar se a pessoa já possui o perfil de funcionário
                if (pessoaMap.get("perfis").toString().contains("FUNCIONARIO")) {
                    ...
                    // Adicionar o perfil de funcionário à pessoa existente
                    ...
                    // Criar e preparar o objeto funcionário para salvar, sem enviar o CPF
